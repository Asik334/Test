          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
            <NumericInput
              ...
              style={{
                ...
                transition: 'border-color 200ms, box-shadow 200ms, width 120ms ease, background 200ms, color 200ms',
                flexShrink: 0,
              }}
            />
            <span style={{
  ...
  return (
    <button
      ...
      style={{
        ...
        background: hovered ? t.toggleHover : 'transparent',
        color: t.unitColor,
        fontSize: 12,
        fontWeight: 600,
        fontFamily: 'inherit',
        ...
        cursor: 'pointer',
        transition: 'background 160ms, color 160ms, transform 100ms, border-color 160ms',
      ...
      <>
        <style>{`
          ...
          *, *::before, *::after {
          ...
          @media (max-width: 400px) {
            .card { padding: 24px 20px 28px; border-radius: 20px; }
          }
        ...
        <div className="app-bg" style={{ background: t.bg }}>
          ...
          >
            ...
            <p className="task-label" aria-hidden="true" style={{ color: t.taskLabel }}>
              Task
            </p>
